...
namespace MineLib.PGL.Data
{
    ...
    public struct PlayerAbilities
    {
        ...
        {
            get { return Convert.ToBoolean((Flags >> 3) & 1); }
        }

        public bool CanFly
        {
            get { return Convert.ToBoolean((Flags >> 2) & 1); }
        }

        public bool IsFlying
        {
            get { return Convert.ToBoolean((Flags >> 1) & 1); }
        }

        public bool CreativeMode
        {
            get { return Convert.ToBoolean((Flags >> 0) & 1); }
        }

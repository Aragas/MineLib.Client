            ...
            foreach (var entry in _minecraftJar.SelectEntries(selectCriteria))
            {
                switch (entry.FileName)
                {
                    ...
                    case "assets/minecraft/textures/gui/title/background/panorama_0.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Panorama0 = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/title/background/panorama_1.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Panorama1 = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/title/background/panorama_2.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Panorama2 = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/title/background/panorama_3.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Panorama3 = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/title/background/panorama_4.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Panorama4 = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/title/background/panorama_5.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Panorama5 = Texture2D.FromStream(_graphicsDevice, ms);
                        break;
                    #endregion
                    ...
                    case "assets/minecraft/textures/gui/title/mojang.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Mojang = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/title/minecraft.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Minecraft = Texture2D.FromStream(_graphicsDevice, ms);
                        break;
                    #endregion
                    ...
                    case "assets/minecraft/textures/gui/container/creative_inventory/tabs.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Tabs = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/container/creative_inventory/tab_items.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.TabItems = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/container/creative_inventory/tab_item_search.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.TabItemSearch = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/container/creative_inventory/tab_inventory.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.TabInventory = Texture2D.FromStream(_graphicsDevice, ms);
                        break;
                    #endregion
                    ...
                    case "assets/minecraft/textures/gui/container/villager.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Villager = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/container/stats_icons.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.StatsIcons = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/container/inventory.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Inventory = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/container/horse.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Horse = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/container/hopper.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Hopper = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/container/generic_54.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Generic54 = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/container/furnace.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Furnace = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/container/enchanting_table.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.EnchantingTable = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/container/dispenser.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Dispenser = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/container/crafting_table.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.CraftingTable = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/container/brewing_stand.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.BrewingStand = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/container/beacon.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Beacon = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/container/anvil.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Anvil = Texture2D.FromStream(_graphicsDevice, ms);
                        break;
                    #endregion
                    ...
                    case "assets/minecraft/textures/gui/achievement/achievement_icons.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.AchievementIcons = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/achievement/achievement_background.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.AchievementBackground = Texture2D.FromStream(_graphicsDevice, ms);
                        break;
                    #endregion
                    ...
                    case "assets/minecraft/textures/gui/widgets.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Widgets = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/stream_indicator.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.StreamIndicator = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/resource_packs.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.ResourcePacks = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/options_background.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.OptionsBackground = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/icons.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Icons = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/demo_background.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.DemoBackground = Texture2D.FromStream(_graphicsDevice, ms);
                        break;

                    case "assets/minecraft/textures/gui/book.png":
                        ms = new MemoryStream();
                        entry.Extract(ms);
                        GUITextures.Book = Texture2D.FromStream(_graphicsDevice, ms);
                        break;
                    #endregion

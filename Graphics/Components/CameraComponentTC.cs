...
namespace MineLib.PCL.Graphics.Components
{
    ...
    {
        internal PCL.Data.BigData.World World { get; set; }

    }

    public sealed class CameraComponentTC<T> : GameComponent where T : struct, IVertexType
    {
        float fovAngle;
        ...
        public CameraComponentTC(Game game, Vector3 position, Vector3 rotation, float speed) : base(game)
        {

...
{
    public sealed class WorldComponent<T> : MineLibGameComponent where T : struct, IVertexType
    {
#if DEBUG
...
#pragma warning restore 649
        ...
        readonly CameraComponentTC<T> _camera;
	    ...
	    public WorldComponent(Client game, CameraComponentTC<T> camera, Minecraft<T> minecraft) : base(game)
	    {

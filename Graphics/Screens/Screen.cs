...
namespace MineLib.PCL.Graphics.Screens
{
    ...
    public abstract class Screen : MineLibGameComponent
    {
        public static GamePadDaisywheel Daisywheel { get; private set; }
        ...
        protected internal MinecraftTextureStorageComponent MinecraftTextureStorage { get { return Game.MinecraftTextureStorage; } }
        ...
        {
            if(Daisywheel == null)
                Daisywheel = new GamePadDaisywheel(Game);

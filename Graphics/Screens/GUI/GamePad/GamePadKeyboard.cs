...
namespace MineLib.PCL.Graphics.Screens.GUI.GamePad
{
    ...
    public delegate void GamePadKeyboardEventHandler(char character);
     ...
     /// </summary>
    public sealed class GamePadDaisywheel : MineLibGameComponent
    {
        ...
        public GamePadDaisywheel(Client game) : base(game)
        {

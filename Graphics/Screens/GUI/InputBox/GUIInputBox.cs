...
using MineLib.PCL.Graphics.Screens.GUI.GamePad;

namespace MineLib.PCL.Graphics.Screens.GUI.InputBox
{
    ...
    public abstract class GUIInputBox : GUIItem
    {
        ...
        private GamePadDaisywheel GamePadDaisywheel { get; set; }
        ...
        protected GUIInputBox(Client game, Screen screen, InputBoxEventHandler onEnterPressed, Color style) : base(game, screen)
        {
            ...
            GamePadDaisywheel = Screen.Daisywheel;
        }
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            */
            ...
            {
                if (GamePadDaisywheel.IsHidden)
                {
                    GamePadDaisywheel.ResetEvents();
                    GamePadDaisywheel.OnCharReceived += GamePadDaisywheelOnOnCharReceived;
                    GamePadDaisywheel.OnCharDeleted += GamePadDaisywheelOnOnCharDeleted;

                    GamePadDaisywheel.IsHidden = false;
                }
                else
                    GamePadDaisywheel.IsHidden = true;
            }
        ...
        {
            GamePadDaisywheel.Draw(gameTime);
        }

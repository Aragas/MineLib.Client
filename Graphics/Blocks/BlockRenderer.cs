...
namespace MineLib.PCL.Graphics.Blocks
{
    // From
    // https://github.com/SirCmpwn/TrueCraft/blob/master/TrueCraft.Client/Rendering/BlockRenderer.cs
    // Maybe use. TODO: Test later
    public class BlockRenderer
    {
        ...
        public virtual VertexPositionNormalColorTexture[] Render(BlockDescriptor descriptor, Vector3 offset, Tuple<int, int> textureMap, int indiciesOffset, out int[] indicies)
        {
        ...
        protected static VertexPositionNormalColorTexture[] CreateQuad(CubeFace face, Vector3 offset, Vector2[] texture, int textureOffset, int indiciesOffset, out int[] indicies, Color color)
        {
